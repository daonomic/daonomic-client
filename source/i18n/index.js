...
import paymentsListNamespace from '~/i18n/translations/payments-list/en.json';
import referralProgramNamespace from '~/i18n/translations/referral-program/en.json';
